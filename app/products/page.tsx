...
import { BrainCircuit, CreditCard, CalendarCheck } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="border-purple-100 hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">AI Appointment Booking System</h3>
              <p className="text-muted-foreground mb-4">
                Custom meeting booking solution with smart AI agents for any website.
              </p>
              <div className="flex justify-between items-center mb-4">
                <span className="text-lg font-bold text-purple-700">₪4,890</span>
              </div>
              <Link href="/#contact">
                <Button variant="default" className="w-full bg-purple-700 hover:bg-purple-800">
                  Contact Us
                </Button>
              </Link>
            </CardContent>
